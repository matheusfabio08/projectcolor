...
export function injectedClientModule(name, env, opts = {}) {
    ...
    function injectedCode() {
        ...
        return `
      const MOCHA_ENV = {
        ORIGIN: ${envValue(env.ORIGIN)},
        APP_ID: ${envValue(env.APP_ID)},
        APP_URL: ${envValue(env.APP_URL)},
        SHOW_WATERMARK: ${envValue(env.SHOW_WATERMARK)},
        NODE_ENV: ${envValue(env.NODE_ENV)},
        PLUGINS: ${envValue(env.PLUGINS)},
        DEBUG_LOGS: ${envValue(env.DEBUG_LOGS)},
      };
