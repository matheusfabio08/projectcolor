function postMessageToParent(message) {
    if (window.parent) {
        window.parent.postMessage(message, MOCHA_ENV.ORIGIN || '*');
    }
}
...
if (import.meta.hot) {
    ...
    import.meta.hot.on('vite:outdatedOptimizeDeps', (data) => {
        postMessageToParent({ type: 'vite:hmr:outdatedOptimizeDeps', data });
    });
}
